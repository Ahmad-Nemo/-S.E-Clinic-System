...
<style>
 ...
 <?php include ("header.php");?>
        ...
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 element-animate">
              <h1>Doctors</h1>
              <p>Hiering the most Intellegence and Expert Doctors.</p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-3 element-animate">
            <div class="media d-block media-custom text-center">
              <img src="img/drbasel2.jpg" alt="Image Placeholder" class="img-fluid">
              <div class="media-body">
                <h3 class="mt-0 text-black">Dr. Basel Bahaa</h3>
                <p>Head of ICU department Abbassia Chest Hospital.<br>Chest Consultant</p>
                <p>
          ...
          <div class="col-md-3 element-animate">
            <div class="media d-block media-custom text-center">
              <img src="img/drhisham.jpg" alt="Image Placeholder" class="img-fluid">
              <div class="media-body">
                <h3 class="mt-0 text-black">Dr. Hisham Mortada</h3>
                <p>Chest Consusltant<br>Vice Manager of Abbassia Chest Hospital.</p>
                <p>
                  <a href="#" class="p-2"><span class="fa fa-facebook"></span></a>
                  <a href="#" class="p-2"><span class="fa fa-twitter"></span></a>
                  <a href="#" class="p-2"><span class="fa fa-linkedin"></span></a>
          ...
          <div class="col-md-3 element-animate">
            <div class="media d-block media-custom text-center">
              <img src="img/unknown1.png" alt="Image Placeholder" class="img-fluid">
              <div class="media-body">
                <h3 class="mt-0 text-black">Dr.Shaimaa Abo El Dahab</h3>
                <p>Chest and ICU Bronchoscopy Specialist at Abbassia Chest Hospital.</p>
                <p>
                  <a href="#" class="p-2"><span class="fa fa-facebook"></span></a>
                  <a href="#" class="p-2"><span class="fa fa-twitter"></span></a>
                  <a href="#" class="p-2"><span class="fa fa-linkedin"></span></a>
          ...
          <div class="col-md-3 element-animate">
            <div class="media d-block media-custom text-center">
              <img src="img/unknown1.png" alt="Image Placeholder" class="img-fluid">
              <div class="media-body">
                <h3 class="mt-0 text-black">Dr.Marwa Mekkawy</h3>
                <p>Chest and ICU Bronchoscopy Specialist at Abbassia Chest Hospital.</p>
                <p>
                  <a href="#" class="p-2"><span class="fa fa-facebook"></span></a>
                  <a href="#" class="p-2"><span class="fa fa-twitter"></span></a>
        ...
        <div class="row mb-5">
          <div class="col-md-3 element-animate">
            <div class="media d-block media-custom text-center">
              <img src="img/unknown1.png" alt="Image Placeholder" class="img-fluid">
              <div class="media-body">
                <h3 class="mt-0 text-black">Dr.Iman Hassan</h3>
                <p>Chest and ICU Bronchoscopy Specialist at Abbassia Chest Hospital.</p>
                <p>
                  <a href="#" class="p-2"><span class="fa fa-facebook"></span></a>
                  <a href="#" class="p-2"><span class="fa fa-twitter"></span></a>
          ...
          <div class="col-md-3 element-animate">
            <div class="media d-block media-custom text-center">
              <img src="img/unknown1.png" alt="Image Placeholder" class="img-fluid">
              <div class="media-body">
                <h3 class="mt-0 text-black">Dr. Safaa Ahmed</h3>
                <p>Chest and ICU Bronchoscopy Specialist at Abbassia Chest Hospital.</p>
                <p>
                  <a href="#" class="p-2"><span class="fa fa-facebook"></span></a>
                  <a href="#" class="p-2"><span class="fa fa-twitter"></span></a>
          ...
          <div class="col-md-3 element-animate">
            <div class="media d-block media-custom text-center">
              <img src="img/unknown1.png" alt="Image Placeholder" class="img-fluid">
              <div class="media-body">
                <h3 class="mt-0 text-black">Dr. Shaymaa Wageeh</h3>
                <p>Chest and ICU Bronchoscopy Specialist at Abbassia Chest Hospital.</p>
                <p>
                  <a href="#" class="p-2"><span class="fa fa-facebook"></span></a>
                  <a href="#" class="p-2"><span class="fa fa-twitter"></span></a>
    ...
    <a href="resview.php" class="cta-link element-animate">
