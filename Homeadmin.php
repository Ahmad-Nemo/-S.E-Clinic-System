    ...
    <section class="home-slider owl-carousel">
        ...
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 element-animate">
              <h1>Welcome Doctor here you can manage all your work </h1>
      ...
      <div class="slider-item" style="background-image: url('img/ans1.png');">
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 element-animate">
              <h1>You can answer all tour patients questions</h1>
        ...
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 element-animate">
              <h1>You can file on all your patients data Appointments and consultations </h1>
