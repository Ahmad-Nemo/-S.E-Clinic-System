...
<body>
    ...
    if (isset($_POST["submit"]))
    {
        ...
        $sql="INSERT INTO users(FirstName,LastName,Email,Password,Phoneno,DOB,gender,TypeID,status) VALUES ('$firstname','$lastname','$email','$password1','$phoneno','$DOB','$gender',1,'pending')";
