        ...
        <div class="row">
          ...
          <div class="col-md-4 border-right element-animate" data-animate-effect="fadeInLeft">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><span>01</span> Medical Services</a>
                 <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false"><span>02</span> Patient Services</a>
              
                <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false"><span>03</span> Expert Doctors</a>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 element-animate">
            <h2 class="text-uppercase mb-4">Center Experience</h2>
            <p class="lead">
The center includes an elite of consultants and specialists in all chest diseases, chest allergies, pulmonary infections, lung tumors, pleural effusion, tuberculosis and pulmonary obstructive diseases. We have experience in bronchoscopy, chest ultrasound, pulmonary function tests, and intensive care.</p>
            <p class="mb-5"></p>
    ...
    <a href="resview.php" class="cta-link element-animate" data-animate-effect="fadeIn" >
