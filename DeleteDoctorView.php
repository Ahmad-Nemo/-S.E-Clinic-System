...
<?php   include_once ("Admin.php");
        include_once ("DeleteDoctorModel.php");
        include_once("DeleteDoctorController.php");
        $model=new DeleteDoctorModel();
        $controller=new DeleteDoctorController($model);
...
<body>
  ...
  <table class="table" id="myTable">
    <thead>
      ...
      <?php
      $controller->retriveuser();
      $sr=1;
      $result=$model->getusers();
      while($row=mysqli_fetch_array($result)){
              ?>
    <tr>
      <form action="DeleteDoctorView.php"method="post" >
        <td> <?php echo $sr;?></td>
